...
const navItems = [
  ...
  },
  {
    ...
    links: [
      ...
      { to: '/admin/employees/new', label: 'Add Employee', icon: 'M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2 M12.5 7a4 4 0 1 1 0 .001 M20 8v6 M23 11h-6', badge: 'New', color: '#10b981' },
    ]
  },
]
          ...
          <div className="sb-footer">
            <div className="sb-user">
              ...
              <div>
                ...
                <div className="sb-urole">{user?.role === 'superadmin' ? 'Super Admin' : (user?.role || 'Admin')}</div>
              </div>
