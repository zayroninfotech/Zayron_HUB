  ...
  superadmin: [
    {
      ...
      color: '#6366f1',
      links: [
        { to: '/admin/employees', label: 'All Employees', icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg> },
      ],
    },
    {
      key: 'hr', label: 'HR',
      ...
      <aside className={`sb-root ${open ? 'open' : ''}`}>
        ...
        <div className="sb-panel">
          ...
          <div className="sb-profile">
            ...
            {/* Quick pills */}
            <div className="sb-quick-pills">
              <NavLink to="/admin/dashboard" className="sb-quick-pill" onClick={() => setSelectedKey(null)}>
                <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
                Dashboard
              </NavLink>
              <NavLink to="/admin/change-password" className="sb-quick-pill">
